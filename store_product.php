                                    ...
                                    <div class="hover-state" style="background-image: linear-gradient(<?php echo hex2rgb($primary_color_1_HEX , '0.9'); ?>, <?php echo hex2rgb($primary_color_1_HEX , '0.9'); ?> ),url(<?php echo the_post_thumbnail_url(); ?>);" >
                                        ...
                                        <div class="row no-margin">
                                            <div class="col-12" style="padding:0px 5px 0px 0px;">
                                                <a href = "<?php echo get_site_url()."/user/single_product.php?product_id=".get_the_ID();?>" ><button class="btn theme-rounded-button primary-color1 primary-color2-background primary-color2-border primary-color2-border-hover transparent-background-hover primary-color2-hover" style="width:100%;padding: 1em 1.5em!important;box-shadow:none!important;" >View Product</button></a>
                                            </div>
