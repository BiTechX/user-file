    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <div class="padding-15px" style="margin-bottom:20px;">
                ...
                <a href="settings_5_shipping.php"><button class="btn theme-rounded-button secondary-color1-border secondary-color1-border-hover secondary-color1 transparent-background top-bar-button current-page-button" >Shipping</button></a>
            ...
            <form action="javascript:void(0)" id="UserInfoUpdate" method=POST enctype=multipart/form-data >
                ...
                <h6 class="secondary-color1 dashboard-title3 no-margin" style="padding:12px;margin-bottom:0px !important;">CHANGE YOUR SHIPPING ADDRESS</h6>
                ...
                <div class="row no-margin">
                    ...
                    <div class="col-xl-3 col-lg-4">                            
                        <div class="form-group">
                            <h6 class="dashboard-title3 small-text secondary-color1" style="text-transform:none;">Town/City</h6>
                            <div id="category" >
                        ...
                        <div class="form-group">
                            <h6 class="dashboard-title3 small-text secondary-color1" style="text-transform:none;">Zip Code</h6>
                            <div id="category" >
